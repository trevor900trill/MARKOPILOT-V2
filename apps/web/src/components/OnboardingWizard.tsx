    ...
    try {
      ...
      const brandRes = await fetch(`${API_BASE_URL}/brands`, {
        ...
        body: JSON.stringify({
          ...
          industry_custom: formData.industry === "Other" ? formData.industryCustom : null,
          target_audience_description: formData.audienceDescription,
          target_job_titles: formData.jobTitles,
          target_pain_points: formData.painPoints,
          target_geographies: formData.geographies,
          brand_voice_formality: formData.formality.toLowerCase(),
          brand_voice_humour: formData.humour.toLowerCase(),
          brand_voice_assertiveness: formData.assertiveness.toLowerCase(),
          brand_voice_empathy: formData.empathy.toLowerCase(),
